...
files_to_check <- c(
  ...
  "tools/clean_intermediates.R",
  "tools/finalize_run.R",
  "tools/harmonize_gwas.R",
  ...
  "tools/checks/smoke_test_ld_timeout.R",
  "tools/checks/smoke_test_chunked_harmonization.R",
  ...
  "tools/checks/smoke_test_shard_runtime.R",
